...
RUN apt-get install -y autoconf build-essential cmake docbook-mathml  libcunit1-dev libgdal-dev libgeos++-dev libgeotiff-dev libgmp-dev libjson0-dev libjson-c-dev liblas-dev libmpfr-dev libopenscenegraph-dev libpq-dev libproj-dev libxml2-dev postgresql-server-dev-9.5 xsltproc git build-essential wget 
...
RUN cd postgis-2.2.0 && ./configure --with-geos=/usr/local/bin/geos-config
...
# installed packages
RUN apt-get remove -y --purge autoconf build-essential cmake docbook-mathml   libcunit1-dev libgdal-dev libgeos++-dev libgeotiff-dev libgmp-dev libjson0-dev libjson-c-dev liblas-dev libmpfr-dev libopenscenegraph-dev libpq-dev libproj-dev libxml2-dev postgresql-server-dev-9.5 xsltproc git build-essential wget 
